"""Regression checks for the quartz-mesh-raft-hub casebook."""
...
from casebook.harness import assert_expected, quartz_mesh_raft_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(quartz_mesh_raft_hub_summary(), assert_expected())
